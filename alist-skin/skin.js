...
const baseUrl = "https://cdn.jsdelivr.net/gh/medlar01/cdn@0.0.19/alist-skin"
// 加载jq
...
window.onload = function() {
    ...
    load("skinCss", "link", { rel: "stylesheet", href: `${baseUrl}/static/skin${_config.cached.is_dark  ? "-dark" : ""}.css` })
